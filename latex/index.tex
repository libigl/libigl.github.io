...
The {\itshape core} library only depends on the standard template library ({\ttfamily \doxylink{namespacestd}{std}:\+:\+}) and Eigen. These functions reside directly the \href{./namespaceigl.html}{\texttt{{\ttfamily igl:\+:\+} namespace}}
