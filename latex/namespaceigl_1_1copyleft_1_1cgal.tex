...
\item[\mbox{\hyperlink{bug__bug000001}{Bug}}]This only computes distances to triangles. So unreferenced vertices and degenerate triangles (segments) are ignored. \end{DoxyRefDesc}
...
@parm\mbox{[}in\mbox{]} V \#V by 3 list of vertex positions @parm\mbox{[}in\mbox{]} F \#F by 3 list of triangle indices 
\begin{DoxyParams}[1]{Parameters}
...
\end{DoxyParams}
\begin{DoxyRefDesc}{Bug}
\item[\mbox{\hyperlink{bug__bug000002}{Bug}}]If an existing edge in (V,F) lies exactly on another face then any resulting additional vertices along that edge may not get properly connected so that the output mesh has the same global topology. This is because …\end{DoxyRefDesc}
\hypertarget{namespaceigl_1_1copyleft_1_1cgal_autotoc_md5}{}\doxyparagraph{\texorpdfstring{Example.}{Example.}}\label{namespaceigl_1_1copyleft_1_1cgal_autotoc_md5}
